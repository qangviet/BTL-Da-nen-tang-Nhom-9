            ...
            sethistoryVisible(true);
                  ...
                  <View>
                        ...
                        <View className="ml-10 mr-10">
                              ...
                              <TouchableOpacity className="rounded-lg bg-red-700 h-10 justify-center mt-5 w-72 self-center" onPress={handleFilePick}>
                              ...
                              <TouchableOpacity className="rounded-lg bg-red-700 h-10 justify-center mt-5 w-32 self-center" onPress={handleSubmitAbsenseRequest}>
